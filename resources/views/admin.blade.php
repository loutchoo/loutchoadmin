...
<body class="bgcolor text-white sm:text-lg">
    <header class="container mx-auto px-4 py-6 sm:flex sm:items-center sm:justify-between  ">
        <div class="flex justify-center">
            ...
            <a href="/" class="font-bold text-white text-lg sm:text-xl mt-4 sm:mt-2 ml-2">LoutchoDev</a>
        </div>
    ...
    <div class="flex justify-center">
        <div class="inline-block">
            ...
            <form action="{{ route('admin') }}" method="POST">
                @csrf
                <input class="p-2 border-2 border-black rounded-lg block mt-2 text-black" type="password"
                    placeholder="New password" name="newpassword">
                <input class="p-2 border-2 border-black rounded-lg block mt-4 text-black" type="password"
                    placeholder="New password" name="newpassword2">
                <div class="flex justify-center mt-2">
                    <button type="submit"
                        class="p-2 rounded-lg bg-black text-white font-semibold block">Change</button>
                </div>
        </div>
        </form>
    </div>
