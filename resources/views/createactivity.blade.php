...
<body class="bgcolor text-white text-lg">
    ...
    <h1 class="text-4xl font-semibold text-center mt-2 animate__animated animate__bounceInDown">Create an activity for
        your Todolist :</h1>
    ...
    <div class="flex justify-center mt-4 animate__animated animate__bounceInDown">
        <div class="inline-block">
            ...
            <div class="flex justify-center mt-8">
                <button type="submit"
                    class="p-2 bg-green-600 border-green-700 border-4 rounded-md hover:opacity-75">Add to
                    ToDoList</button>
                </form>
            </div>
            <div>
