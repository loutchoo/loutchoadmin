...
<body class="bgcolor text-white sm:text-lg">
    <header class="container mx-auto px-4 py-6 sm:flex sm:items-center sm:justify-between  ">
        <div class="flex justify-center">
            ...
            <a href="/" class="font-bold text-white text-sm text-lg sm:text-xl mt-4 sm:mt-2 ml-2">LoutchoDev</a>
        </div>
                ...
                <div class="inline-block mt-8">
                    <div class="mt-4">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="flex justify-center">
                                <button type="submit"
                                    class="block bg-white text-black font-semibold border-black border-4 rounded-full p-3 sm:p-2 px-4 mt-6 hover:opacity-75">Login</button>
                        </form>
                    </div>
                    <div class="mb-14"></div>
                </div>
